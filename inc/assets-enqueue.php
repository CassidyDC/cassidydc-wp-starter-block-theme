 ...
 */
if ( ! function_exists( 'CassidyDC\WPStarterBlockTheme\enqueue_theme_assets' ) ) :
	/**
...
add_action( 'wp_enqueue_scripts', 'CassidyDC\WPStarterBlockTheme\enqueue_theme_assets' );

/**
 * Enqueue editor UI assets
 */
if ( ! function_exists( 'CassidyDC\WPStarterBlockTheme\enqueue_editor_ui_assets' ) ) :
	/**
...
add_action( 'enqueue_block_editor_assets', 'CassidyDC\WPStarterBlockTheme\enqueue_editor_ui_assets' );

/**
 * Enqueue editor iframe content stylesheets
 */
if ( ! function_exists( 'CassidyDC\WPStarterBlockTheme\enqueue_editor_styles' ) ) :
	/**
...
add_action( 'after_setup_theme', 'CassidyDC\WPStarterBlockTheme\enqueue_editor_styles' );

/**
 * Enqueue individual block stylesheets
 */
if ( ! function_exists( 'CassidyDC\WPStarterBlockTheme\enqueue_block_styles' ) ) :
	/**
	 * Enqueue individual block stylesheets
	 *
	 * @since 1.0.0
...
add_action( 'after_setup_theme', 'CassidyDC\WPStarterBlockTheme\enqueue_block_styles' );
