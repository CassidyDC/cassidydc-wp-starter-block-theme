 ...
 * Register theme assets
 */
if ( ! function_exists( 'CassidyDC\WPStarterBlockTheme\register_theme_assets' ) ) :
	/**
	 * Register theme assets
	 *
	 * @since 1.0.0
...
add_action( 'wp_enqueue_scripts', 'CassidyDC\WPStarterBlockTheme\register_theme_assets' );

/**
 * Register editor UI assets
 */
if ( ! function_exists( 'CassidyDC\WPStarterBlockTheme\register_editor_ui_assets' ) ) :
	/**
	 * Register editor UI assets
	 *
	 * @since 1.0.0
...
add_action( 'enqueue_block_editor_assets', 'CassidyDC\WPStarterBlockTheme\register_editor_ui_assets' );

/**
 * Register theme block pattern categories
 */
if ( ! function_exists( 'CassidyDC\WPStarterBlockTheme\register_theme_block_pattern_categories' ) ) :
	/**
	 * Register theme block pattern categories
	 *
	 * @since 1.0.0
...
add_action( 'init', 'CassidyDC\WPStarterBlockTheme\register_theme_block_pattern_categories' );
